...
> Lightweight utilities to assemble voxel lattices, generate 3D beam element configurations, build a global stiffness matrix, solve with Dirichlet boundary conditions, and (optionally) infer top‑face displacements from a few strain sensors.
